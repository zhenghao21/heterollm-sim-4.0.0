"""Create an exclusive, byte-verified R24 evidence packet after scoring finishes.
...
THRESHOLD = 180 * 1024
EXCLUDED_DIRECTORIES = {"execution_source", "source", "sources", "source_snapshot", "source_snapshots",
...
def package(root, *, packet_name=PACKET_NAME, index_name=INDEX_NAME, list_only=False):
    ...
    document = {"schema": SCHEMA, "created_utc": datetime.now(timezone.utc).isoformat(),
        ...
        "selection_policy": {"scope": "round_024 descendants only",
