...
def check(freeze_path, arm):
    ...
    spec = importlib.util.spec_from_file_location("r30_frozen_api", root / "tools/predict_stable_native_dataset.py")
    ...
    for cell in cells:
        ...
        expected_mode = {"off": "legacy_mma_output_wave", "on": "nominal_bandwidth_analytical_fallback"}[arm]
...
def main(argv=None):
    ...
    result = {"schema": "r30-frozen-source-preflight/v1", "stage": args.stage, "arm": args.arm,
