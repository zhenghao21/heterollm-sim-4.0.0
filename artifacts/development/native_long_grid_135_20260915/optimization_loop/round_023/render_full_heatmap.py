"""Presentation-only rendering of immutable R23 engine error scores; no scoring/refit."""
...
def main():
 a=argparse.ArgumentParser(description=__doc__);a.add_argument('--score',type=Path,default=ROOT/'retained/errors.0002.json');a.add_argument('--output',type=Path,default=ROOT/'full_engine_error_heatmap.png');args=a.parse_args()
 ...
 fig.suptitle('R23 qualified retained KV state candidate | Fixed native development set | Engine absolute relative error (%)',fontsize=15,y=.995)
