...
阶段：full。retained 全三项严格小于10%：5/131；A=not_passed，B=unvalidated。新增系数0。
...
retained 已保存预测 131/131；缺失 0；失败或未评分 27/131。
终态结果（含failure）131/131；三项可评分 104/131。
...
| model:smollm2 | 23 | 0 | 0 |
| model:tinyllama | 22 | 0 | 0 |
| scope:fallback | 69 | 5 | 27 |
| scope:retained_covered | 62 | 0 | 0 |

retained 全131 APE：
- TTFT：51.281% / 68.045% / 72.496%
- TPOT：35.277% / 53.228% / 64.773%
- E2E：36.456% / 54.676% / 66.189%

未评分原因（按指标计数）：
- prediction unavailable or incomplete: 81
