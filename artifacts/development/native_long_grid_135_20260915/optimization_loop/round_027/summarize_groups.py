"""Post-barrier R27 group and paired report; never run predictions or native."""
...
spec=importlib.util.spec_from_file_location("r27_reporting_runner",P/"run_candidate.py")
...
def render(report):
    lines=["# R27 paired output-selection evaluation", "", "Development only; fixed native 131 cells. Independent B: unvalidated.", "",
...
def main():
    ...
    report={"schema":"r27-grouped-paired-errors/v1","created_utc":r.now(),"scoring_report_ref":bref,"barrier_ref":barrier_ref,
            ...
            "old_R25_failed_attempt":"preserved; this new paired evaluation does not retroactively accept prior failure"}
