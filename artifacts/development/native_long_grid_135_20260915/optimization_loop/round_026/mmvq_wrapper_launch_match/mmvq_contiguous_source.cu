...
extern "C" void heterollm_mmvq_probe_main(
    ...
    ggml_cuda_mm_fusion_args_device fusion{};ContiguousLayout layout{};
    GGML_ASSERT(contiguous_layout(k,n,m,ggml_blck_size(type),q8_1_stride_blocks,layout));
    mul_mat_vec_q_switch_type(packed_weight,type,q8_1,nullptr,fusion,output,
        k,n,m,layout.row_x,layout.col_y,layout.col_dst,
        1,1,1,layout.channel_x,layout.channel_y,layout.channel_dst,
        1,1,layout.sample_x,layout.sample_y,layout.sample_dst,0,stream);
}
