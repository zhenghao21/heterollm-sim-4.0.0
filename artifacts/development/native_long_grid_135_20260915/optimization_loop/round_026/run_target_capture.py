...
LOOP=P.parent
CAP=P/'mmvq_target_capture'
MANIFEST=CAP/'build_manifest.0004.json'
MANIFEST_SHA='ba01258ed733d082db9776fb72aa9dc65f64d7e52bd0fcb549c5b8af7de2ceca'
HOST_TEST=CAP/'host_test.0003.json'
HOST_TEST_SHA='c263ee6e40908b58948f9639a94d4083534e9c2af5ba933a67b24a4b8d614f8a'
...
def verify_build():
    ...
    require(len(raw_test.get('tests',[]))==len(set(raw_test.get('tests',[])))==38,'host test list mismatch')
    ...
    require(test.get('returncode')==0 and test.get('inputs_unchanged') is True and test['result'].get('test_count')==38 and test['result'].get('status')=='passed','host qualification missing')
...
def execute():
    ...
    output=P/'target_capture_run.0001'
