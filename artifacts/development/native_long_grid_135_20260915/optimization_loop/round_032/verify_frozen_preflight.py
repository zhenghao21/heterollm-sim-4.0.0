...
def check(freeze_path, arm):
    ...
    spec = importlib.util.spec_from_file_location("r32_frozen_api", root / "tools/predict_stable_native_dataset.py")
...
def main(argv=None):
    ...
    result = {"schema": "r32-frozen-source-preflight/v1", "stage": args.stage, "arm": args.arm,
