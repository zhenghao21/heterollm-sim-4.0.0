...
spec=importlib.util.spec_from_file_location("r32_postprocess_tests",Path(__file__).with_name("postprocess.py"))
...
def test_R32_receipt_uses_declared_gate_without_inventing_blind_field():
    receipt={"schema":"r32-two-arm-scoring-receipt/v1","denominator_per_arm":131,
