...
import pytest
spec=importlib.util.spec_from_file_location("r33_groups_test",Path(__file__).with_name("summarize_groups.py"));d=importlib.util.module_from_spec(spec);spec.loader.exec_module(d)
def fixture():
