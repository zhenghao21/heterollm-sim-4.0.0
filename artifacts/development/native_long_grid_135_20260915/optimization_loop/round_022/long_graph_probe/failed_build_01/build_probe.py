...
def main() -> None:
    ...
    probe = common + [str(PACKAGE / "long_graph_main.cpp"), f"/Fe:{PACKAGE / 'long-graph-probe.exe'}", f"/Fo:{PACKAGE / 'long-graph-probe.obj'}", "/link", str(base_lib), str(cuda_lib), toolchain["cuda_library"], "bcrypt.lib"]
