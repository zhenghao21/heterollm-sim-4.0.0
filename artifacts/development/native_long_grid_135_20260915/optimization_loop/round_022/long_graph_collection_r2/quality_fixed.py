...
import statistics
POLICY={
    'config_count':2,'arm_count':1,'process_pairs':3,'calls_per_process':36,'formal_calls_per_process':30,
...
def quality(config,pairs):
    ...
    return {'config':config,'status':'diagnostic_quality_accepted' if eligible else 'diagnostic_quality_rejected',
        ...
        'calibration_eligible':False,'fit_performed':False,'holdout_not_for_fit':True,'experiment_group':'long_graph_diagnostic' ,
