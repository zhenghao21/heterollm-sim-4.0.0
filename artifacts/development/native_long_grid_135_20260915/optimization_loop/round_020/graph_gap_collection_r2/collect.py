...
def prepare():
    ...
    proof_path=HERE.parent/'graph_gap_runtime_identity.json'
    ...
    paths=[proof_path,Path(__file__),HERE/'strict_raw.py',HERE/'native_trace.py',HERE/'quality_fixed.py',PROBE/'build_manifest.json',PROBE/'protocol.json']
