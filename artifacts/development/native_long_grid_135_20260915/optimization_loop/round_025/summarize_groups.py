"""Post-barrier R25 group and paired report; never run predictions or native."""
...
spec=importlib.util.spec_from_file_location("r25_reporting_runner",P/"run_candidate.py")
...
def render(report):
    lines=["# R25 paired output-selection evaluation", "", "Development only; fixed native 131 cells. Independent B: unvalidated.", "",
...
def main():
    ...
    report={"schema":"r25-grouped-paired-errors/v1","created_utc":r.now(),"scoring_report_ref":bref,"barrier_ref":barrier_ref,
