...
E:\anaconda\python.exe build.py host-test --manifest build_manifest.0001.json
~~~

未来仅root串行，所有R26/identity/native/simulator/GPU任务自然完成、project idle后：
~~~powershell
E:\anaconda\python.exe run_probe.py --manifest build_manifest.0001.json --execute-untimed-qualification
~~~
