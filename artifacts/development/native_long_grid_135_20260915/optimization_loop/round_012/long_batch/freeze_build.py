...
for name in ['source_reference.h','reference_host.cpp','reference-host.exe','test_source_reference.py','host_reference_validation.json','stream_event_probe.cpp','identity_lock.h','identity_lock.json','protocol.json','invoke.ps1','run_frozen_matrix.ps1','assess.py','full_raw_audit.py','summarize_matrix.py','test_quality_tools.py','freeze_build.py','compile.cmd','README.md','copied_source_provenance.json','revision_provenance.json','static_validation.json','check_environment.ps1','environment_validation.json','environment_echo.cpp','environment-echo.exe','test_quality_tools.log','powershell_validation.json','compile.log','stream-event-probe.exe']:
    value=ref(p/name)
